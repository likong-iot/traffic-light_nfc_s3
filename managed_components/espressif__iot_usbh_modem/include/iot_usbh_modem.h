...
/**
 * @brief Get the latest USB modem diagnostic snapshot
 *
 * @param[out] diag Output diagnostic structure
 *
 * @return true if a snapshot was copied, false if unavailable
 */
bool usbh_modem_get_diag(usb_modem_diag_t *diag);
