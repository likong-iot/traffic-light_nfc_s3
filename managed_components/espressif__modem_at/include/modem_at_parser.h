...
/**
 * @brief Check whether the AT parser is stopped
 *
 * @param at_handle AT parser handle
 *
 * @return true if stopped or invalid, false if command processing is enabled
 */
bool modem_at_is_stopped(at_handle_t at_handle);
